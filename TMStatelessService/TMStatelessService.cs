...
namespace TMStatelessService
{
    /// <summary>
    /// An instance of this class is created for each service instance by the Service Fabric runtime.
    /// </summary>
    internal sealed class TMStatelessService : StatelessService
    {
        public TMStatelessService(StatelessServiceContext context)
            : base(context)
        { }
        ...
        {            //yield return new ServiceInstanceListener(context => this.CreateWcfCommunicationListener(context));   
            return new List<ServiceInstanceListener>()
            {
                ...
                new ServiceInstanceListener(context => this.CreateWcfCommunicationListener(context), "TMServiceEndpoint"),
        ...
        private ICommunicationListener CreateWcfCommunicationListener(StatelessServiceContext context)
        {
            ...
            var listener = new WcfCommunicationListener<IOMSClient>(
                ...
                wcfServiceObject: new TransactionManager.TransactionManager(),
